...
function renderChart(){
  ...
  paxis.innerHTML='';
  for(var k=7;k>=0;k--){var sp=document.createElement('span');sp.textContent=fp(mn+range*k/7);paxis.appendChild(sp)}
  var maxV=1;
